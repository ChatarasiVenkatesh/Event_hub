...
export const OrganizerDashboard = () => {
  ...
  const monthlyData = [
    { month: 'Jan', events: 2, registrations: 45, revenue: 2250 },
    { month: 'Feb', events: 1, registrations: 23, revenue: 1150 },
    { month: 'Mar', events: 3, registrations: 67, revenue: 3350 },
    { month: 'Apr', events: 2, registrations: 34, revenue: 1700 },
    { month: 'May', events: 4, registrations: 89, revenue: 4450 },
    { month: 'Jun', events: 1, registrations: 12, revenue: 600 }
  ];
  ...
  const eventPerformanceData = events.map(event => ({
    ...
    registrations: registrations.filter(reg => reg.eventId === event.id).length,
    capacity: event.capacity || 100,
    revenue: registrations.filter(reg => reg.eventId === event.id).length * (event.price || 0)
  }));
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <AreaChart data={monthlyData}>
                      ...
                      <Area type="monotone" dataKey="events" stackId="2" stroke="#10B981" fill="#10B981" fillOpacity={0.6} />
                    </AreaChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>Registration and revenue by event</CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
