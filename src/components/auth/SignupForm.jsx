        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              >
                <div className="flex items-center space-x-2 border rounded-lg p-4 hover:bg-muted/50">
                  ...
                  <div className="flex-1">
                    <Label htmlFor="user" className="font-medium">Event Attendee</Label>
                ...
                <div className="flex items-center space-x-2 border rounded-lg p-4 hover:bg-muted/50">
                  ...
                  <div className="flex-1">
                    <Label htmlFor="organizer" className="font-medium">Event Organizer</Label>
                    <p className="text-sm text-muted-foreground">
            ...
            <Button
              type="submit"
              className="w-full"
              disabled={loading || (selectedRole === USER_ROLES.USER && selectedInterests.length < 3)}
            >
